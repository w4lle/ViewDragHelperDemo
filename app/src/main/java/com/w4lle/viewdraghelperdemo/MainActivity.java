...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMenuFragment = (LeftMenuFragment) fm.findFragmentById(R.id.layout_container);
        if (mMenuFragment == null) {
            fm.beginTransaction().add(R.id.layout_container, mMenuFragment = new LeftMenuFragment()).commit();
        }
